...
> **Total** 234 · **Complete** 146 · **P0 open** 3 · **P1 open** 36 · **P2 open** 46 · **Externally blocked** 3
>
...
- [x] Deterministic test-wallet provider for E2E. The app frame is now behind
...
- [x] The security explainer (session vs allowance vs mandate) is now behind the wallet
...
- [x] Landing page rebuild against the kit: hero watercolor with grain, six feature
